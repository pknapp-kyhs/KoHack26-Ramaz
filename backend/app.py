...
from eleven import generate_tts_with_timestamps, get_daily_mishnah_data, save_outputs
...
def translate_to_text(translator, text, src, dest):
...
def translate_text():
    ...
    try:
        ...
        translated_text = translate_to_text(translator, text, src, dest)
...
def get_hebrew_text():
    ...
    try:
        ...
        return jsonify({
            "error": "Failed to load daily Mishnah text",
            "details": str(e)
        }), 500
...
def generate_tts():
    ...
    try:
        ...
        translator = Translator()
        english_text = translate_to_text(translator, hebrew_text, src='he', dest='en')
